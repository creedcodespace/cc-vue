...
export default {
	data() {
		return {
			userImg: '/assets/img/user/user-1.jpg',
			gallery10: '/assets/img/gallery/gallery-10.jpg',
			mailData: [{
				id: 1,
				sender: 'Apple',
				time: '1 hour ago',
					...
					<perfect-scrollbar class="h-100">
						...
						<div class="mailbox-detail">
							...
							<div class="mailbox-detail-header">
								<div class="d-flex">
									<a href="#">
										<img :src="userImg" alt="" width="40" class="rounded-circle" />
									</a>
									<div class="flex-fill ms-3">
										<div class="d-lg-flex align-items-center">
											...
											<div class="fs-12px text-white text-opacity-50 text-lg-end mt-lg-0 mt-3">Nov 27, 2025 <span class="d-none d-lg-inline"><br /></span>at 7.00pm</div>
										</div>
									</div>
								</div>
							</div>
